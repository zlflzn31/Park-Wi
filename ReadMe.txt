...
2. To avoid hard coding, I made an ReturnType enum and HandRank enum to store possible return values, depending on success or type of error occurred. In addition, I declared as const int all constant values.
...
Extra Credit
------------
We have implemented a TexasHoldEm class that creates and plays a TexasHoldEm class. Please refer to TexasHoldEm.cpp and TexasHoldEm.h.
